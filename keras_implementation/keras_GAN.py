...
step_size = 5
feature_num = 6
n_test_days=int(len(df_final)/10)
print('test_days')
print(n_test_days)
n_train_days = len(df_final.values)- n_test_days
print('train_days')
print(n_train_days)
...
train,test,scaler = data_preprocessing(step_size=step_size,df_final=df_final,n_train_days=n_train_days)
